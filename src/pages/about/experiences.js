...
const Experiences = ({ className }) => {
  const experiences = [
    {
      ...
      description: `Converting legacy jQuery code to React code base. Contributing 'Kupondas' tab of the Nesine.com`,
      stack: ['React', 'JavaScript'],
      image: {
        path: '/nesine-logo.png',
        alt: 'Nesine Logo',
        width: 48,
        height: 48,
      },
  ...
  return (
    <section className={`mt-12 flex flex-col justify-start gap-3 ${className}`}>
      ...
      <Stepper
        className='ml-5'
        iconClassName='ring-4 ring-gray-300 dark:ring-neutral-600'
      >
